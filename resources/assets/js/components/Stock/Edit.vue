...
<script>
	...
	export default{
		...
		methods:{
			edit(id){
				var self = this;
	  			axios.get('/stock/'+id).then(function(response){
	  				self.form.id = response.data.id;
	  				self.form.name = response.data.name;
	  				self.form.display_name = response.data.display_name;
	  				self.form.description = response.data.description;
	  				self.form.jumlah = response.data.jumlah;
	  				self.form.satuan = response.data.satuan;
	  				self.form.harga_beli = response.data.harga_beli;
	  				self.form.harga_jual = response.data.harga_jual;
	  			});
				this.sE = true;
			},
			onSubmit(){
				this.form.patch('/stock/'+this.form.id)
					.then(response=> {
